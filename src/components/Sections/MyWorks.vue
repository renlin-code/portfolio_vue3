...
const works = reactive([
  {
    ...
    details: [
      ...
      "Создание и написание компонентов и программирование их функционнальности (Nuxt2 - Options API)",
  ...
  },
  {
    ...
    details: [
      "Создание и настроика базы данных на Postgres SQL",
      "CRUD-сервис для управления данными в базе",
      "Middlewares для филтрация запросов с клиентской стороны и также для аутентификации и авторизации c помощью JWT",
      "Написание эндпоинтов для RESTful API",
      "Подключение к SMTP-серверу для отправленя пользователю емайлов для подверждения почты и восстановления пароля",
    ],
    deploy_address: "https://time-master.netlify.app/",
  ...
  },
  {
    ...
    details: [
      "Резиновая верстка макетов орентированная под мобильными устройствами",
      "Создание и написание компонентов и программирование их функционнальности (Vue2 - Options API)",
  ...
  },
  {
    ...
    details: [
      ...
      "Создание и написание компонентов и программирование их функционнальности (Vue3 - Composition API)",
