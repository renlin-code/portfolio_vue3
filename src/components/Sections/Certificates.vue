<template>
  <section id="certificates" class="certificates renlincode-section">
    ...
    <div class="certificates__content main-content-wrapper">
      <h2 class="certificates__title renlincode-title section-title">Сертификаты</h2>
      <div class="certificates__wrapper">
        <p class="certificates__text">
          Я стараюсь постоянно совершенствоваться, в чем вы можете убедиться, посмотрев на
          мои сертификаты. Большинство курсов и сертификатов я получил на популярной
          латиноамериканской платформе
          <a
            target="_blank"
